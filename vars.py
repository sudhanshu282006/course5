...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8483883899:AAFimhkw1B8_CrbNYy7hjV1wPe5hzM5iY3c")

CREDIT = os.environ.get("CREDIT", "sss")
...
OWNER_ID = int(os.environ.get("OWNER_ID", "1363113279"))
